...
const object = {
  ...
  content: {
    ...
    inner: "relative flex pb-4 flex-col rounded-lg bg-white shadow ",
  },
  body: {
...
export default function Page() {
  ...
  const [modalStatus2, setOpenModal2] = useState(false);
        ...
        <div className="col-span-12 md:col-span-3 flex flex-col space-y-4 md:space-y-2 2xl:gap-4">
          <div className="rounded">
            <p className="text-white text-justify font-myriadl 2xl:text-lg">
              Make your travel plans to Jakarta, Singapore, and Kuala Lumpur
              with our AI Travel Assistant. Tailored to your preferences, let us
              be your guide and discover the world in a way that feels just
              right for you.
            </p>
          </div>
          <div className="border-gradient flex-grow">
            <div className="bg-dark w-full h-full flex flex-col items-center justify-center gap-2 2xl:gap-4 py-3">
              <img
                className="sm:h-18"
                src={locations[data.location]}
                alt={data.location}
              />
              <p className="text-xl text-white font-bold font-conthrax">
                {data.location}
              </p>
            </div>
          </div>
          <Button
            ...
            className="flex items-center text-center sm:flex md:hidden lg:hidden xl:hidden 2xl:hidden z-50 mb-2 font-conthrax bg-teal w-full py-2 rounded-md hover:bg-teal-600 transition-colors  cursor-pointer outline-none focus:ring-0"
          >
            Change Chat
          </Button>
          ...
          <div className="border-gradient py-2 2xl:py-10 flex flex-col ">
            <div className="cursor-pointer text-white p-3 rounded-lg flex flex-col  font-myriad">
              <div
                ...
                className="z-50 mt-0 cursor-pointer p-2.5 rounded-lg flex flex-col justify-between items-between font-myriad gap-0.5"
              >
                <span className="flex gap-2 text-md 2xl:text-xl font-conthrax">
                  ...
                  >
                    <path
                      d="M17.2583 5.8668C17.5833 5.5418 17.5833 5.00013 17.2583 4.6918L15.3083 2.7418C15 2.4168 14.4583 2.4168 14.1333 2.7418L12.6 4.2668L15.725 7.3918M2.5 14.3751V17.5001H5.625L14.8417 8.27513L11.7167 5.15013L2.5 14.3751Z"
                      fill="white"
                    />
                  </svg>
                </span>
                <div className="flex flex-col gap-4 py-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="bg-teal size-12 flex justify-center items-center rounded-full">
                      ...
                      >
                        <path
                          d="M0 7.49902C0 5.61302 -5.96046e-08 4.67102 0.586 4.08502C1.172 3.49902 2.114 3.49902 4 3.49902H16C17.886 3.49902 18.828 3.49902 19.414 4.08502C20 4.67102 20 5.61302 20 7.49902C20 7.97002 20 8.20602 19.854 8.35302C19.707 8.49902 19.47 8.49902 19 8.49902H1C0.529 8.49902 0.293 8.49902 0.146 8.35302C-8.9407e-08 8.20602 0 7.96902 0 7.49902ZM0 16.499C0 18.385 -5.96046e-08 19.327 0.586 19.913C1.172 20.499 2.114 20.499 4 20.499H16C17.886 20.499 18.828 20.499 19.414 19.913C20 19.327 20 18.385 20 16.499V11.499C20 11.028 20 10.792 19.854 10.645C19.707 10.499 19.47 10.499 19 10.499H1C0.529 10.499 0.293 10.499 0.146 10.645C-8.9407e-08 10.792 0 11.029 0 11.499V16.499Z"
                          fill="white"
                        />
                        <path
                    ...
                    <div>
                      ...
                      <p className="text-lg font-myriadb">
              ...
              <button
                onClick={generate}
                className="z-50 mb-2 hover:bg-black font-conthrax bg-teal w-full py-2 rounded-md hover:bg-teal-600 transition-colors  cursor-pointer"
              >
        ...
        <div className="col-span-12 md:col-span-7 flex flex-col space-y-4 h-full  justify-between">
            ...
            {!loadingPanel ? (
              <div className="overflow-auto flex flex-col space-y-4 ">
                {messages.map((el, i) => {
                  let iframeSrc = "";
                  if (el.latlng)
                    iframeSrc = `https://www.google.com/maps/embed/v1/place?q=${
                      el.latlng.lat
                    },${el.latlng.lng}&key=${import.meta.env.VITE_GMAP}`;
                  if (el.role === "user") {
                    return (
                      <div
                        key={i}
                        className="flex flex-col rounded-lg max-w-5/6 self-end userchat py-2 px-3"
                      >
                        <Markdown
                          rehypePlugins={[rehypeRaw]}
                          remarkPlugins={[remarkGfm]}
                          className="prose px-3 py-2 !text-white"
                        >
                          {el.content}
                        </Markdown>
                        {el.latlng && (
                    ...
                    return (
                      <div
                        key={i}
                        className="aianswer flex flex-col w-full rounded-lg p-1.5"
                      >
                        <div className="flex items-center gap-2 py-2">
                          <div className="ml-2 circleai w-8 h-8 rounded-full"></div>
                          <p className="text-white font-conthrax text-[12px]">
                            HANGOUT AI
                          </p>
                        </div>
                        <Markdown
                          rehypePlugins={[rehypeRaw]}
                          remarkPlugins={[remarkGfm]}
                          className="prose px-3 py-2 !text-white max-w-full"
                        >
                          {el.content}
                        </Markdown>
                        {el.metadata && (
          ...
          <div className="bottom-0 relative h-28">
            <textarea
              ...
              className="absolute w-full h-28 py-2 px-2.5 text-white font-myriadl bg-[#1A1C22] border border-[3px] border-[#6C7B96] h-20 rounded-lg justify-self-end"
            ></textarea>
            <Button
              onClick={chat}
              size="sm"
              gradientMonochrome="cyan"
              className="absolute bg-white right-5 bottom-[20px]"
            >
              Submit
            </Button>
          </div>
        ...
        <div className="hidden col-span-12 md:col-span-2 rounded-2xl md:flex flex-col">
          <div className="border-gradient w-full flex-grow flex flex-col">
            <div className="z-50 bg-dark w-full flex flex-col">
              <p className="text-white text-lg font-conthrax py-2 text-center">
                List Chat
              </p>
              <hr />
                    ...
                    return (
                      ...
                      >
                        <div
                          className={
                            !chatId
                              ? "w-2 h-2 rounded-full bg-[#4DC0C7] mb-1.5"
                              : "w-2 h-2 rounded-full bg-transparent mb-1.5"
                          }
                        ></div>
      ...
      >
        ...
        <Modal.Body>
          <div className="space-y-4">
            <p className="font-conthrax text-xl font-medium text-gray-900 dark:text-white">
              Change Your Chat
            </p>
            <div className="w-full">
              <p>
                Click the card to change the chat. by default the active chat is
                the one with blue bullet icon.{" "}
              </p>
            </div>
            <div className="flex flex-col flex-grow overflow-y-auto max-h-[80vh] gap-4">
              {listChat.map((el, i) => {
                let { id, name, date, subhead } = el;
                if (!id) {
                  return (
                    <div
                      onClick={() => {
                        moveId("").then(() => setOpenModal2(false));
                      }}
                      key={i}
                      className="bg-[#01010E] rounded-lg flex gap-2 p-2 group cursor-pointer pt-3.5"
                    >
                      <div
                        className={
                          !chatId
                  ...
                  return (
                    <div
                      onClick={() => {
                        moveId(`${id}`).then(() => setOpenModal2(false));
                      }}
                      key={i}
                      className="bg-[#01010E] rounded-lg group flex gap-2 p-2 cursor-pointer hover:text-[#A3E8EB]"
                    >
                      <div
                        className={
                          Number(chatId) === id
